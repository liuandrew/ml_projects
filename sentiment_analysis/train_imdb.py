...
valid_data = (train_data[0][0:2000], train_data[1][0:2000])
train_data = (train_data[0][2000:], train_data[1][2000:])
...
dropout = 0.2
model = TransformerSentiment(ntokens, emsize, nhead, d_hid, nlayers, 
